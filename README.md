  ...
  deploy:
    ...
    - uses: autovance/s3-sync-action@master
      ...
      env:
        ...
        SOURCE_DIR: 'public'
        DEST_DIR: s3://${{ secrets.AWS_S3_BUCKET }}/path
```
...
| `SOURCE_DIR` | The local directory (or file) you wish to sync/upload to S3. For example, `public`. Defaults to your entire repository. | `env` | Yes | N/A |
| `DEST_DIR` | The directory inside of the S3 bucket you wish to sync/upload to. For example, `my_project/assets`. Defaults to the root of the bucket. | `env` | Yes | N/A |
